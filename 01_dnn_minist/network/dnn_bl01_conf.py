...
class dnn_bl01_conf(object):
    ...
    def __init__(self, input_layer_val, input_layer_val_dim, mode):
        ...
        with tf.device('/gpu:0'), tf.variable_scope("fully_connected_layer02") as scope:
        ...
        with tf.device('/gpu:0'), tf.variable_scope("fully_connected_layer03") as scope:
        ...
        with tf.device('/gpu:0'), tf.variable_scope("fully_connected_layer04") as scope:
        ...
        with tf.device('/gpu:0'), tf.variable_scope("fully_connected_layer05") as scope:
            self.output_layer05 = self.fully_layer(self.output_layer03,
                                                   ...
                                                   self.dnn_para.l05_is_act,
                                                   self.dnn_para.l05_act_func, 

                                                   self.dnn_para.l05_is_drop,
                                                   self.dnn_para.l05_drop_prob,
            ...
            self.final_output = self.output_layer05
